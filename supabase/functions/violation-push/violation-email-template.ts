/** Auto-synced from violation-email.html — do not edit by hand; run: node scripts/sync-violation-email-template.mjs */
export const VIOLATION_EMAIL_HTML = `<!DOCTYPE html>
...
<head>
  ...
  <style>
    ...
    .athar-alert { background-color: #fafafa !important; background-image: linear-gradient(#fafafa, #fafafa) !important; color: #18181b !important; }
    ...
    u + .body .athar-alert { background-color: #fafafa !important; background-image: linear-gradient(#fafafa, #fafafa) !important; color: #18181b !important; }
    ...
    [data-ogsc] .athar-alert { background-color: #fafafa !important; color: #18181b !important; }
  </style>
</head>
      ...
      <table role="presentation" class="athar-card" width="100%" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff" style="max-width:480px;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);border-radius:16px;border:1px solid #e4e4e7;">
        <tr>
          <td align="center" class="athar-card" bgcolor="#ffffff" style="padding:32px 28px 16px;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);">
            <img src="https://athar-app.online/icons/athar-wordmark-email-v388.png" width="240" height="148" alt="ATHAR" style="display:block;width:240px;max-width:100%;height:auto;border:0;margin:0 auto;">
          </td>
        </tr>
        <tr>
          <td dir="rtl" class="athar-card" bgcolor="#ffffff" style="padding:8px 28px 28px;text-align:right;background-color:#ffffff;background-image:linear-gradient(#ffffff,#ffffff);">
            <p class="athar-title" style="margin:0 0 16px;font-size:16px;line-height:1.7;color:#18181b;">مرحباً {{RECIPIENT_NAME}}،</p>
            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="100%" style="margin:0 0 20px;">
              <tr>
                <td class="athar-alert" bgcolor="#fafafa" style="font-size:17px;font-weight:700;line-height:1.65;color:#18181b;background-color:#fafafa;background-image:linear-gradient(#fafafa,#fafafa);border:1px solid #e4e4e7;border-radius:14px;padding:16px 18px;text-align:right;">
                  {{TITLE}}
                </td>
              </tr>
            </table>
            <p class="athar-body" style="margin:0 0 24px;font-size:15px;line-height:1.75;color:#3f3f46;white-space:pre-line;">{{MESSAGE}}</p>
            <p class="athar-muted" style="margin:0 0 12px;font-size:13px;line-height:1.65;color:#71717a;">رسالة تلقائية من منصة أثر. لا ترد على هذا البريد.</p>
            <p class="athar-muted" style="margin:0;font-size:12px;line-height:1.6;color:#71717a;">افتح تطبيق أثر للاطلاع والمتابعة.</p>
          </td>
        </tr>
      </table>
    </td>
